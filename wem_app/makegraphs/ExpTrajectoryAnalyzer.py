...
class ExpTrajectoryAnalyzer(WemVisualsMaker):
    ...
    def _read_data(self) -> None:
        ...
        If experiment data is already provided, it checks if the data is in the correct format.
        If not, it reads the data files from the specified folder path and updates the experiment data.
        Here the loaded data is expected to be a dictionary with generations as keys and lists of words as values.
        """
        first_element = None
    ...
    def _process_data(self) -> None:
        """
        Process the experiment data to compute attributes.
        """
    ...
    def create_trajectory_graph(self, 
        ...
        save : bool, optional
            If True, the plot will be saved to a file, by default True
    ...
    def create_trajectory_animation(self,
        ...
        animation_speed : int, optional
            The speed of the animation in milliseconds, by default 200
        save : bool, optional
            If True, the animation will be saved to a file, by default True
        subplot : plt.Axes, optional
            A matplotlib Axes object to plot the animation on. If None, a new figure and axes will be created, by default None
            
        Returns
        -------
        list[FuncAnimation]
            A list of FuncAnimation objects for each trial.
        """
