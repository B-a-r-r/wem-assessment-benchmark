...
class Judge(WemActor):
    ...
    judgments_history : dict[int, dict[tuple[str, str], str]]
        A dictionary containing the judgments history, where keys are generation numbers and values are dictionaries of word pairs and their chosen word.
    _jugements_history_logs : TextIOWrapper | None
        The file object for the judgments history log file.
    criteria : str
        The criteria used for judging the words.
    _model : LanguageModelHandler
        The language model handler used for generating responses.
    """
    ...
    def __init__(self,
        ...
        enable_logs: bool, optional
            If True, enable logging to a file (default is True).
        """
    ...
    def _log_event(self, 
        ...
        indent : str, optional
            The indentation to use for the log entry (default is an empty string).
        underline : bool, optional
            If True, underline the event in the log (default is False).
        type : str, optional
            The type of the event (default is None).
        """
